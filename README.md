...
Small Python port scanner for checking common TCP and UDP service ports on a target IP address.

The script tests a predefined list of ports and prints the services that appear to be open.
